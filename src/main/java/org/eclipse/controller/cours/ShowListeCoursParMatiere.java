 ...
 */
@WebServlet("/liste-cours")
public class ShowListeCoursParMatiere extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowListeCoursParMatiere() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("connected") == null)
    		...
    		session.removeAttribute("idMat");
    		session.setAttribute("idMat", idMatiere);
    		...
    		this.getServletContext().getRequestDispatcher("/WEB-INF/CoursViews/showListeCoursParMatiere.jsp").forward(request, response);
    	}	
	}
