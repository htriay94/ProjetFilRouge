...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div class="container theme-showcase">
			<hr>
			<h1 style="text-align: center;">Calendrier des cours <c:out value="${ sessionScope.user_auth.groupe.nomGroupe }"></c:out></h1>
...
(function ($) {
  ...
  ;(function (defaults, $, window, document) {
    ...
    months: ["Janvier", "Fevrier", "Mars", "Avril", "May", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Decembre"],
    shortMonths: ["Jan", "Fev", "Mar", "Avr", "May", "Juin", "Juil", "Août", "Sept", "Oct", "Nov", "Dec"],
    date: (new Date()),
...
<c:forEach items="${ listeCours }" var="cours" varStatus="status">
	data.push({ title: '${cours.matiere.nomMatiere} - ${cours.nomCours}', start: new Date("<fmt:formatDate pattern="yyyy-MM-dd" value="${cours.dateCours}" />"), end: new Date("<fmt:formatDate pattern="yyyy-MM-dd" value="${cours.dateCours}" />"), allDay: true, text: '${cours.nomCours}'  });
</c:forEach>
